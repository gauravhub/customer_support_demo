...
# Script to deploy order-management-api to Kubernetes
...
echo "=========================================="
echo "DEPLOYING ORDER MANAGEMENT API"
echo "=========================================="
...
echo "  kubectl get deployment order-management-api"
echo "  kubectl get pods -l app=order-management-api"
echo ""
echo "To view logs:"
echo "  kubectl logs -f deployment/order-management-api"
echo ""
echo "To get endpoint:"
echo "  kubectl get ingress order-management-api-ingress -o jsonpath='{.status.loadBalancer.ingress[0].hostname}'"
echo ""
